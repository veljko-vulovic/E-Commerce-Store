...
<div class="p-3 text-black bg-white rounded-md">
    ...
    {{-- <img class="w-full rounded-md" src="{{ $product->image }}" alt="Product image"> --}}
    <img class="w-full rounded-md" src="https://source.unsplash.com/random/200x200?sig=incrementingIdentifier"
        alt="Product image">
