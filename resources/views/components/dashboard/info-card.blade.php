<div class="rounded-md px-7 py-6 shadow-sm bg-[#24303F] mt-4">
    <div class="flex items-center justify-center rounded-full h-11 w-11 bg-gray-800/80">

        <svg class="fill-white" width="22" height="16" viewBox="0 0 22 16" fill="none"
