        ...
        <div class="flex justify-between">
            <div class="space-y-4">
                @foreach ($carts as $item)
                    <div class="flex w-full p-4 mx-auto space-x-10 text-black bg-white rounded-md h-72">
                        <img src="https://source.unsplash.com/random/320x320?sig={{ rand(1, 100) }}" alt=""
                            class="">
                        <div class="flex justify-between w-full">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <form action="{{ route('cart.update', $item->id) }}" method="POST">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button
                                                class="flex items-center px-4 py-3 space-x-3 text-lg font-bold text-white bg-blue-500 rounded-full"
                                                type="submit">
                                                <span>Update</span>
                                            </button>
                                        </div>
                            ...
                            <div class="flex flex-col justify-between space-y-10">
                                ...
                                <form action="{{ route('cart.destroy', $item->id) }}" method="POST">
                                    ...
                                    @method('delete')
                                    <button
                                        class="flex items-center px-4 py-3 space-x-3 text-lg font-bold text-white bg-red-500 rounded-full"
            ...
            <div class="sticky flex flex-col top-10 w-[300px] p-4 text-black bg-white rounded-md h-72">
                ...
                <a class="flex justify-center px-4 py-3 mt-auto text-lg font-bold text-white bg-red-500 rounded-full "
